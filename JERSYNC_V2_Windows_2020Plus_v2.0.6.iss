...
OutputDir=Output
OutputBaseFilename=JERSYNC_V2_Installer_Windows_2020Plus_v2.0.6_CacheFix
Compression=lzma2
...
[Files]
Source: "JERSYNC_V2\*"; DestDir: "{userappdata}\Adobe\CEP\extensions\JERSYNC_V2"; Flags: ignoreversion recursesubdirs createallsubdirs
